...
if(isset($_GET['editid'])){
    ...
    $query="SELECT * FROM admin_auth WHERE id='$id'";
...
if ($_SERVER["REQUEST_METHOD"]=="POST" && isset($_POST['update'])) {
    ...
    if (empty($username) || empty($password) || empty($email) || empty($role)){
     ...
     echo $msg;
        ...
        $query="update admin_auth set username='$username',password='$password',email='$email',role='$role' where id='$id'";
...
?>
         ...
         <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="card">
                ...
                <input type="hidden" name="password" class="form-control" value="<?php echo $password;?>" required>
                <br>
