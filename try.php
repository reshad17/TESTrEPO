        ...
        <input type="hidden" name="cus_phone" value="<?php echo $_SESSION['phone'];?>" class="form-control">
          ...
          <input type="submit" class="btn btn-success" type="submit" value="Pay Now" name="done" id="submit"> 
            ...
            <div class="col-md-5" style="background-color: pink; padding: 20px; border-radius: 10px;">
              <label>Note:</label>
              <p readonly="">
 <b>Amount should be greater than BDT 200 or equivalent to BDT 200.<b><br><br> <b>BDT 200 will be deposited in the Help Fund and the remaining amount will be deposited in the Self Fund from the amount.<b><br><br><b>***Payment getway charges will add to total amount you pay.<b>
              </p>
            </div>
