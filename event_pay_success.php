...
$event_name=$_SESSION['event_session_name'];
$query = "insert into event_pay (username,event_name,amount,email,date) values ('$username','$event_name','$amount','$email','$pay_time')";
...
setTimeout(function () {
   window.location.href= 'http://localhost/9800Batch/event_pay_his.php'; // the redirect goes here
