...
<section id="main-content">
 ...
 <div class="panel panel-default">
   ...
   <?php
    ...
    $q = "SELECT * FROM add_event where email='$email'";
   ...
   <form method="post" action="https://sandbox.aamarpay.com/index.php" target="_blank" name="myForm" onsubmit="return validateForm()" enctype="multipart/form-data">
      ...
      <div class="card">
       ...
       <label> Event Name </label>
         <input type="text" name="event_name" class="form-control" value="<?php echo $_SESSION['event_session_name'];?>" readonly>
       <br>
       ...
       <input type="hidden" value="aamarpay" name="store_id" class="form-control">
        ...
        <input type="hidden" name="cus_name" class="form-control" value="<?php echo $_SESSION['event_session_name'];?>">
