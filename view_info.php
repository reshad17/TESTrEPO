...
<section id="main-content">
 ...
 <div class="panel panel-default">
    <div class="panel-heading">
     <b>View User Information</b>
    </div>
    <div>
        <?php
        if (isset($_GET['delid'])) {
    $id=$_GET['delid'];
    $query="DELETE FROM add_info WHERE id='$id'";
    $result=mysqli_query($con,$query);

    if ($result) {
        $msg = "<div style='margin-top: 50px'class='alert alert-danger'>
                      <strong>Information deleted successfully</strong>
                    </div>";
                    echo $msg;
    }
}
?>
 ...
 ?>
    ...
    <tr class="text-center">
        ...
        <td>
          <a href="edit_info.php?editid=<?php echo base64_encode($res['id']); ?>" ><i class="fa fa-edit"></i> </a>|| 
        <a href="?delid=<?php echo $res['id']; ?>" onclick="return confirm('Are you sure you want to delete this information?')"><i class="fa fa-trash"></i></a>
          
        </td>
         <td>
          <a href="view_all_info.php" ><i class="fa fa-list-alt" aria-hidden="true"></i> </a>
