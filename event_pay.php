...
$_SESSION['event_session_name']=$event_name;
...
<section id="main-content">
 ...
 <form method="post" action="event_confirm_pay.php" name="myForm" onsubmit="return validateForm()" enctype="multipart/form-data">
      ...
      <div class="card">
       ...
       <label> Event Name </label>
         <input type="text" name="event_name" class="form-control" value="<?php echo $event_name;?>" readonly>
       <br>
       ...
       <input type="text" name="amount" class="form-control" required="" value="<?php echo $amount;?>">
        ...
        <input type="hidden" value="http://localhost/9800Batch/success.php" name="success_url" class="form-control">
        


        <input type="hidden" value="http://localhost/9800Batch/fail.php" name="fail_url" class="form-control">
        

        
        <input type="hidden" name="cancel_url" value="http://localhost/9800Batch/fail.php" class="form-control">
        ...
        <input type="hidden" name="cus_phone" value="<?php echo $_SESSION['phone'];?>" class="form-control">
          ...
          <input type="submit" class="btn btn-success" type="submit" value="Pay Now" name="done" id="submit"> 
            ...
            <div class="col-md-5" style="background-color: pink; padding: 20px; border-radius: 10px;">
              <label>Note:</label>
              <p readonly="">
              	<b>Payment getway charges will add to event amount you pay.<b>
              </p>
            </div>
